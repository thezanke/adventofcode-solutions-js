...
import { hexToBinaryString, part1, part2 } from './day16.js';
...
describe('2021 - Day 16', () => {
  describe('hexToBinaryString()', () => {
    it('returns the expected result', () => {
      expect(hexToBinaryString('D2FE28')).toEqual('110100101111111000101000');
    });

    it('returns the expected result', () => {
      expect(hexToBinaryString('38006F45291200')).toEqual(
        '00111000000000000110111101000101001010010001001000000000'
      );
    });

    it('returns the expected result', () => {
      expect(hexToBinaryString('EE00D40C823060')).toEqual(
