...
class Point {
  ...
  roll () {
    const [x, y, z] = [this.x, this.z, -1 * this.y];
    Object.assign(this, { x, y, z });
  }

  turn () {
    const [x, y, z] = [-1 * this.y, this.x, this.z];
    Object.assign(this, { x, y, z });
  }

  turnReverse () {
    const [x, y, z] = [this.y, -1 * this.x, this.z];
    Object.assign(this, { x, y, z });
  }
}
  ...
  getNeighborDistances () {
    ...
    for (const [b1, d1] of neighborDistances) {
      for (const [b2, d2] of neighborDistances) {
        ...
        const dist = manhattan([b1.x, b1.y, b1.z], [b2.x, b2.y, b2.z]);
...
export const part2 = (input) => {
  ...
  for (const pair of pairs) {
    const [a, b] = pair;
    const mag = manhattan([a.x, a.y, a.z], [b.x, b.y, b.z]);
    if (mag > max) max = mag;
  }
